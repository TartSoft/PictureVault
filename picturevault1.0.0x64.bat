...
:: Delete files that need hidden after have the .rar compress
del /f %FileNeedHidden1%
del /f %FileNeedHidden2%

:: Hide files in the picture "cheemsborgir.jpg" 
cd %Disk%/%FolderName%
copy /b %ImageInputName%.jpg + %CompressName%.rar %ImageOutputName%.jpg
msg * The progress is complete 
PAUSE

:: Ask user want to out or continue using the program
